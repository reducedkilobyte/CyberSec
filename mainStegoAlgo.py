...
import rsa as rsa
import imagePrep as img
import data_embed as stego
...
NUM_CHANNELS = 3
COVER_IMAGE_FILEPATH  = "./test1.png" # Choose your cover image (PNG)
STEGO_IMAGE_FILEPATH  = "./stego_image.png"
SECRET_MESSAGE_STRING = "Yo yo honey singh"
encrypted_msg = rsa.encrypt(public, SECRET_MESSAGE_STRING)
#print("RSA Encrypted message is: ", ''.join(map(lambda x: str(x), encrypted_msg)))
